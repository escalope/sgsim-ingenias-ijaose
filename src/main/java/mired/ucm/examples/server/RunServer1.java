...
public class RunServer1 {
	...
	public static void createFileStatsClient(final SGServer server)
					...
					public void processCycleStatus(NetworkStatus ns,
						...
						try {
							if (sensorOrder.isEmpty()) {
								...
								fos.write(("timestamp;timestampseconds;overvoltage;")
										.getBytes());
							...
							fos.write((timestamp
									+ ";"
									+ ((timestamp.getTime() - initialDate) / 1000l)
