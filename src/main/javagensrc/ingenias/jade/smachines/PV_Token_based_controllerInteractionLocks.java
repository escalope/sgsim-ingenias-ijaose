...
public class PV_Token_based_controllerInteractionLocks implements CustomLocks {

	public PV_Token_based_controllerInteractionLocks() {
	};
	...
	public void addInteractionLocks(String interaction, LocksWriter lw,
		...
		if (interaction.equals("TokenProvidingInt0")
				&& role.equals("TokenRequester")) {
			TokenRequesterTokenProvidingInt0DefaultCommControl
					.addDefaultLocks(lw);
		}
		...
		if (interaction.equals("TokenProvidingInt0")
				&& role.equals("TokenProvider")) {
			TokenProviderTokenProvidingInt0DefaultCommControl
					.addDefaultLocks(lw);
		}
