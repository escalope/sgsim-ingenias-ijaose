 ...
 * 
 * <p>
 * The Task ReturnTokenNT has the following inputs, sets of possible outputs,
 ...
 * </ul>
 */
public class ReturnTokenNTTask extends Task {

	public ReturnTokenNTTask(String id) {
		super(id, "ReturnTokenNT");
	...
	public void execute() throws TaskException {
		...
		fake_RequirePermissionNT_output_for_task_ReturnTokenNT eifake_RequirePermissionNT_output_for_task_ReturnTokenNT = (fake_RequirePermissionNT_output_for_task_ReturnTokenNT) this
				.getFirstInputOfType("fake_RequirePermissionNT_output_for_task_ReturnTokenNT");
